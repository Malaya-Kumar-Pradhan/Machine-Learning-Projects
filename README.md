...
|---|---|---|
| **[Heart Disease Prediction](./Heart-Disease-Prediction/)** | A comparative study of classification algorithms (Logistic Regression, Decision Tree, Random Forest, Gradient Boosting) for early-stage heart disease prediction. | Scikit-learn, Pandas, Matplotlib |
...
| **[Lung Cancer Detection](./Lung-Cancer-Detection/)** | Built a predictive model to classify lung cancer risk based on patient attributes, applying various classification algorithms for high diagnostic accuracy. | Scikit-learn, Pandas, Matplotlib, Seaborn, CatBoost, XGBoost|

You can learn more about my professional background on [LinkedIn](https://www.linkedin.com/in/malaya-kumar-pradhan/) or reach out to me via [Email](malayakumarpradhan716@gmail.com).
