...
|---|---|---|
| **[Heart Disease Prediction](./Heart-Disease-Prediction/)** | A comparative analysis of ensemble methods (CatBoost, XGBoost, Voting Classifier) for the early-stage prediction of heart disease. | Scikit-learn, Pandas, XGBoost, CatBoost, Matplotlib |
...
You can learn more about my professional background on LinkedIn or reach out to me via Email.
